...
This capability defines the requirements for a CharacterList component that fetches and displays characters from the Rick and Morty API in a 2-column grid layout. The component integrates with Zustand for state management, handles loading and error states, and uses FlatList for efficient rendering of character cards.
