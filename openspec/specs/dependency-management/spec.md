...
This capability defines the dependency management strategy for the Rick and Morty React Native application. It covers core dependencies (Expo, React, React Native, TypeScript), navigation dependencies (React Navigation), HTTP client (Axios), state management (Zustand), code quality tools (ESLint, Prettier), and package manager scripts for common development tasks.
